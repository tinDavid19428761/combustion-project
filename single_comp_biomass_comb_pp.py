...
configuration = {
    ...
    "components": {
        ...
        "biomass": { 
            "type": Component,
            "elemental_composition": {"C":6, "H": 10, "O": 5}, #[] cellulose composition  
            ...
            "parameter_data": {
                ...
                "dens_mol_sol_comp_coeff": (2960.415544, pyunits.mol/pyunits.m**3), #62168.73
        ...
        "O2": {
            ...
            "parameter_data": {
                ...
                "cp_mol_ig_comp_coeff": { # valie range 100 K - 700 K
