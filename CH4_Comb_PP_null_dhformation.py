...
configuration = {
    ...
    "components": {
        ...
        "carbon": { 
            ...
            "parameter_data": {
                "cp_mol_sol_comp_coeff": (0, pyunits.J/pyunits.mol/pyunits.K),
        ...
        "CH4": {
            ...
            "parameter_data": {
                ...
                "cp_mol_ig_comp_coeff": {
                    ...
                    # "A": (0	, pyunits.J / pyunits.mol / pyunits.K),  # [4]
                    # "B": (0, pyunits.J * pyunits.mol**-1 * pyunits.K**-1 * pyunits.kiloK**-1),
                    # "C": (0, pyunits.J * pyunits.mol**-1 * pyunits.K**-1 * pyunits.kiloK**-2),
                    # "D": (0, pyunits.J * pyunits.mol**-1 * pyunits.K**-1 * pyunits.kiloK**-3),
                    # "E": (0, pyunits.J * pyunits.mol**-1 * pyunits.K**-1 * pyunits.kiloK**2),
                    # "F": (0, pyunits.kJ / pyunits.mol),
                    # "G": (0, pyunits.J / pyunits.mol /pyunits.K),
        ...
        "H2O": {
           ...
           "parameter_data": {
               ...
               "cp_mol_ig_comp_coeff": {
                   "A": (30.09200,pyunits.J / pyunits.mol / pyunits.K,),  # [4] temperature range 500 K- 1700 K
                ...
                #    "A": (0,pyunits.J / pyunits.mol / pyunits.K,),  # [4] temperature range 500 K- 1700 K
                #    "B": (0,pyunits.J * pyunits.mol**-1 * pyunits.K**-1 * pyunits.kiloK**-1,),
                #    "C": (0,pyunits.J * pyunits.mol**-1 * pyunits.K**-1 * pyunits.kiloK**-2,),
                #    "D": (0,pyunits.J * pyunits.mol**-1 * pyunits.K**-1 * pyunits.kiloK**-3,),
                #    "E": (0,pyunits.J * pyunits.mol**-1 * pyunits.K**-1 * pyunits.kiloK**2,),
            ...
            #    "enth_mol_form_vap_comp_ref": (-285.8304, pyunits.J / pyunits.mol),  # [4]
