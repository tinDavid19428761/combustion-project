...
from  CH4_Comb_PP_null_dhformation import configuration 
from  ch4_comb_reactionsolids import CH4CombReactionParameterBlock
...
flowSolids=1e-20
flowTotal=sum([flowO2,flowCH4,flowN2, flowSolids])
...
m.fs.M101.methane_feed.mole_frac_comp[0,"carbon"].fix(flowSolids/flowTotal) 
m.fs.M101.methane_feed.temperature.fix(1100)
m.fs.M101.methane_feed.pressure.fix(100000)
