"""
Property package for the combustion of coal in air
"""
# Import Pyomo units
...
configuration = {
    ...
    "components": {
        ...
        "coal": { 
            ...
            "parameter_data": {
                "mw": (12.727, pyunits.g / pyunits.mol),
        ...
        "NO2": {
            ...
            "parameter_data": {
                ...
                "cp_mol_ig_comp_coeff": { #valid range 298 K - 1200 K
                    "A": (16.10857	, pyunits.J / pyunits.mol / pyunits.K),  # [4]
                    "B": (75.89525, pyunits.J * pyunits.mol**-1 * pyunits.K**-1 * pyunits.kiloK**-1),
                    "C": (-54.3874, pyunits.J * pyunits.mol**-1 * pyunits.K**-1 * pyunits.kiloK**-2),
                    "D": (14.30777, pyunits.J * pyunits.mol**-1 * pyunits.K**-1 * pyunits.kiloK**-3),
                    "E": (0.239423, pyunits.J * pyunits.mol**-1 * pyunits.K**-1 * pyunits.kiloK**2),
                    "F": (26.17464, pyunits.kJ / pyunits.mol),
                    "G": (240.5386, pyunits.J / pyunits.mol /pyunits.K),
                    "H": (33.09502, pyunits.kJ / pyunits.mol),
                },
        ...
        "SO2": {
            ...
            "parameter_data": {
                ...
                "temperature_crit": (304.18, pyunits.K),  # [6]
                "cp_mol_ig_comp_coeff": { #valid range 298 K - 1200 K
                    "A": (21.43049, pyunits.J / pyunits.mol / pyunits.K),  # [4]
                    "B": (74.35094, pyunits.J * pyunits.mol**-1 * pyunits.K**-1 * pyunits.kiloK**-1),
                    "C": (-57.75217, pyunits.J * pyunits.mol**-1 * pyunits.K**-1 * pyunits.kiloK**-2),
                    "D": (16.35534, pyunits.J * pyunits.mol**-1 * pyunits.K**-1 * pyunits.kiloK**-3),
                    "E": (0.086731, pyunits.J * pyunits.mol**-1 * pyunits.K**-1 * pyunits.kiloK**2),
                    "F": (-305.7688, pyunits.kJ / pyunits.mol),
                    "G": (254.8872, pyunits.J / pyunits.mol /pyunits.K),
                    "H": (-296.8422, pyunits.kJ / pyunits.mol),
                    #valid range 1200-1600
                    # "A": (57.48188, pyunits.J / pyunits.mol / pyunits.K),  # [4]
                    # "B": (1.009328, pyunits.J * pyunits.mol**-1 * pyunits.K**-1 * pyunits.kiloK**-1),
                    # "C": (-0.07629, pyunits.J * pyunits.mol**-1 * pyunits.K**-1 * pyunits.kiloK**-2),
                    # "D": (0.005174, pyunits.J * pyunits.mol**-1 * pyunits.K**-1 * pyunits.kiloK**-3),
                    # "E": (-4.045401, pyunits.J * pyunits.mol**-1 * pyunits.K**-1 * pyunits.kiloK**2),
                    # "F": (-324.414, pyunits.kJ / pyunits.mol),
                    # "G": (302.7798, pyunits.J / pyunits.mol /pyunits.K),
                    # "H": (-296.8422, pyunits.kJ / pyunits.mol),
                },
                "enth_mol_form_vap_comp_ref": (0, pyunits.kJ / pyunits.mol),  # [4]
